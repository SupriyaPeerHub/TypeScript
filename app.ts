...
//   // hare you can use "any" and "unknown" , best approch use "unknown"
//   console.log(arg);
// }
...
// // exaple 2
// function solaj<T>(name: string, roll: number ,arg: T){
//   console.log(name, roll, arg)
// }
...
//   name: string;
//   age: number = 0;
//   constructor(name: string, public Religion: T) {
//     this.name = name;
//   }
// }
// const Prasenjit = new NewBornBaby("Prasenjit", "Hindu"); // hare string likhini, automatic string hoye geche, number o likhte pari
// console.log(Prasenjit);

// // // Generic Interface
// interface NewBornBaby<T> {
//   name: string;
//   age: number;
//   arg: T;
// }
// const solaj: NewBornBaby<string> = {
//   name: "Solaj",
//   age: 10,
//   arg: "ss",
// };
...
// // example 2
// interface ScroeBord<T> {
//   name: string;
//   score: number;
//   showScore(): void;
//   role: T;
// }
// const Arnab: ScroeBord<string> = {
//   name: "Arnab",
//   score: 10,
//   showScore() {
...
// vvip Generics Example 1
// function Xyz<T>(a: T, b: T): T {
//   // return "hey" as T;
//   return <T>"hey";
// }

// console.log(Xyz<string>("10", "20"));
